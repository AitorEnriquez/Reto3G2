...
public class Menu extends JFrame implements ActionListener {
	...
	private JLabel imgNaranja;
	private JLabel imgGris;
	...
	public Menu() {
		...
		setShape(new RoundRectangle2D.Double(32, 32, 1063, 479, 32, 32));
		...
		panelIzq.setBounds(32, 30, 275, 483);
		...
		focusBoton.setBounds(-7, 138, 283, 74);
		panelIzq.add(focusBoton);
		

		imgNaranja = new JLabel("");
		imgNaranja.setIcon(new ImageIcon("C:\\PROG\\ProyectoReto3G2\\src\\imagenes\\rectanguloNaranja.png"));
		imgNaranja.setBounds(-34, 0, 313, 513);
		panelIzq.add(imgNaranja);

		panelDch = new JPanel();
		panelDch.setBackground(Color.LIGHT_GRAY);
		panelDch.setBounds(187, 26, 914, 487);
		...
		lblAgregar.setFont(new Font("Segoe UI", Font.PLAIN, 33));
		lblAgregar.setBounds(207, 117, 140, 46);
		...
		btnAgregarUsuario.setIcon(new ImageIcon("C:\\PROG\\ProyectoReto3G2\\src\\imagenes\\agregarUsuarioo.png"));
		btnAgregarUsuario.setBounds(167, 168, 227, 151);
		...
		lblEliminar.setFont(new Font("Segoe UI", Font.PLAIN, 33));
		lblEliminar.setBounds(453, 118, 140, 46);
		panelDch.add(lblEliminar);
		
		btnEliminarUsuario = new JButton("");
		btnEliminarUsuario.setIcon(new ImageIcon("C:\\PROG\\ProyectoReto3G2\\src\\imagenes\\eliminarUsuarioo.png"));
		btnEliminarUsuario.setBackground(new Color(199, 199, 199));
		btnEliminarUsuario.setBounds(410, 168, 227, 151);
		...
		imgGris = new JLabel("");
		imgGris.setIcon(new ImageIcon("C:\\PROG\\ProyectoReto3G2\\src\\imagenes\\rectanguloGris.png"));
		imgGris.setBounds(88, 0, 923, 521);
		panelDch.add(imgGris);
	...
	public void clickBoton(JButton j) {
		//Si es Clientes
		if (j == btnClientes && !clickBoton.isVisible()) {
			clickBoton.setLocation(-7,138);
			clickBoton.setVisible(true);
			focusBoton.setVisible(false);
			lblNoSeleccion.setVisible(false);
			mostrarBotones(btnClientes);
		}
		else if (j == btnClientes && clickBoton.isVisible()) {
			clickBoton.setVisible(false);
			focusBoton.setVisible(true);
			lblNoSeleccion.setVisible(true);
			ocultarBotones(btnClientes);
		}
		//Si es trabajadores
		else if (j == btnTrabajadores && !clickBoton.isVisible()) {
			clickBoton.setLocation(-7,210);
			clickBoton.setVisible(true);
			focusBoton.setVisible(false);
			lblNoSeleccion.setVisible(false);
			mostrarBotones(btnClientes);
	...
	public void mostrarBotones(JButton j) {
		if (j == btnClientes) {
	...
	public void ocultarBotones(JButton j) {
		if (j == btnClientes) {
			btnAgregarUsuario.setVisible(false);
			lblAgregar.setVisible(false);
			btnEliminarUsuario.setVisible(false);
